...
const moduleData: Record<ModuleKey, { title: string; description: string; tabs: string[]; records: RecordItem[] }> = {
  ...
  configuracoes: {
    ...
    description: 'Emitente, permissoes, backup e logs de auditoria.',
...
const moduleFields: Record<ModuleKey, FieldItem[]> = {
  ...
  planosContas: [
    { label: 'Tipo', placeholder: 'Receita / Despesa / Ambos' },
    { label: 'Grupo', placeholder: 'Receita Operacional, Despesas Fixas, Despesas Variaveis, Impostos, Comissao...' },
    { label: 'Descricao da conta', placeholder: 'Descricao do plano de contas' },
    { label: 'Conta pai', placeholder: 'Conta superior hierarquica (opcional)' },
    { label: 'Natureza', placeholder: 'Entrada / Saida' },
    { label: 'Centro de custo', placeholder: 'Centro de custo (opcional)' },
    { label: 'Status', placeholder: 'Ativo / Inativo' },
    { label: 'Observacoes', placeholder: 'Informacoes adicionais.', wide: true, multiline: true },
  ],
  configuracoes: [
...
const financeTabFields: Record<number, FieldItem[]> = {
  0: [
    ...
    { label: 'Plano de contas', placeholder: 'Conta do plano de contas' },
  ...
  1: [
    ...
    { label: 'Contrato vinculado', placeholder: 'Codigo do contrato' },
    { label: 'Plano de contas', placeholder: 'Conta do plano de contas' },
    { label: 'Documento / Nº parcela', placeholder: 'Ex: Parcela 1/10' },
    { label: 'Parcela', placeholder: 'Ex: 1' },
    ...
    { label: 'Data de recebimento', placeholder: 'dd/mm/aaaa', mask: 'date' },
    { label: 'Valor original', placeholder: 'R$ 0,00', mask: 'currency' },
    { label: 'Juros', placeholder: 'R$ 0,00', mask: 'currency' },
  ...
  2: [
    ...
    { label: 'Data de emissao', placeholder: 'dd/mm/aaaa', mask: 'date' },
    { label: 'Data de vencimento', placeholder: 'dd/mm/aaaa', mask: 'date' },
    { label: 'Data de pagamento', placeholder: 'dd/mm/aaaa', mask: 'date' },
    { label: 'Valor original', placeholder: 'R$ 0,00', mask: 'currency' },
    { label: 'Juros', placeholder: 'R$ 0,00', mask: 'currency' },
    { label: 'Multa', placeholder: 'R$ 0,00', mask: 'currency' },
    { label: 'Desconto', placeholder: 'R$ 0,00', mask: 'currency' },
